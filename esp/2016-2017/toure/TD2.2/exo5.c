...
{
	char alphabet_majuscule[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", alphabet_minuscule[] = "abcdefghijklmnopqrstuvwxyz", alphabet_permutation[26], cle[27], texte_clair [100], texte_crypte [100];
	int i=0, j=0, taille_texte=0, validation=0;
